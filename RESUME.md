...
- Mobile PagePicker & Naskah Stability:
  ...
  2. Fitur Tap-to-Flip Side B dikembalikan 100%: Mengetuk area naskah `#m-reading-stage` mengembalikan pembaca ke karya visual Side A (kecuali saat menyorot teks atau mengklik kontrol/tombol). Popover PagePicker tetap terlindungi dan stabil di ponsel.
