...
| **Homepage Cover Polish (No Navbar & Down Arrow)** | `src/screens/cover.ts`, `src/style.css` | ✅ Done | Navbar dihapus total, masthead simetris, tombol "Buka Buku →" ke Prolog, tombol "Lihat Daftar Isi" dengan panah ke bawah (↓) tersusun vertikal di tengah presisi |
