...
| **Homepage Cover Polish (Yogyakarta, Shadows, Centered Actions)** | `src/screens/cover.ts`, `src/style.css` | ✅ Done | Kicker "YOGYAKARTA · 2026", judul & teks ber-text shadow halus dan kontras, tombol "Buka Buku" bersih tanpa panah, dan tautan "Lihat Daftar Isi" dengan panah (↓) tersusun rapi di tengah |
